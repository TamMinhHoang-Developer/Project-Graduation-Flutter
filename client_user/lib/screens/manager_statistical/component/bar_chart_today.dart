...
class BartChartToday extends StatefulWidget {
  const BartChartToday({super.key});

  final Color dark = Colors.blue;
  final Color normal = Colors.greenAccent;
  final Color light = Colors.redAccent;

  @override
  State<StatefulWidget> createState() => BartChartTodayState();
}

class BartChartTodayState extends State<BartChartToday> {
